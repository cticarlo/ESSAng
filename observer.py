...
class Subject(object):
    ...
    def notify(self, event=None):
        ...
        for listener in self._listeners:
            listener.process_event(event=event)
            
    def setValue(self,Target,newValue):
        u"""
        Altera o valor de uma variavel e dispara o event EventChanged.
        """
        self._values[Target]=newValue
